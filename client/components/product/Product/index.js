...
export const stylesProduct = makeStyles(theme => ({
  root: {
    flexGrow: 1,
    margin: 30,
  },
          ...
          <Grid container spacing={10}>
            <Grid item xs={7} sm={7}>
              <Card className={classes.card}>
                <CardHeader
                  title={product.name}
                  subheader={product.quantity > 0 ? 'En existencias': 'Agotado' }
                  action={
                ...
                <div className={classes.flex}>
                  ...
                  <Typography component="p" variant="subtitle1" className={classes.subheading}>
                    ...
                    <span className={classes.price}>$ {product.price} COP</span>
